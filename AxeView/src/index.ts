...
export default class App
{
	...
	constructor()
	{
		...
		domMenu.insertAdjacentHTML('beforeend', '<a href="../Example/test_Option1.html">옵션 처리</a><br />');
		domMenu.insertAdjacentHTML('beforeend', '<a href="../Example/test_Option2.html">개별 옵션 처리</a><br />');
