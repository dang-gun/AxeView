...
export class OverwatchDomPushHelper
{
		...
		, sMatchString: string)
	{
		...
		this._MyOw.Dom_AxeViewList.push({
			AxeViewMoveType: AxeViewMoveType.HTMLElement
			, Dom: domPushData
			, DataView: ""
			, EventName: null
			, TossOption: jsonOpt
		...
		, sMatchString: string)
	{
		...
		let jsonOpt: { [key: string]: string } = this.MatchToTossOpt(sMatchString);
		this._MyOw.Dom_AxeViewList.push({
			AxeViewMoveType: AxeViewMoveType.Node
			, Dom: domPushData
			, DataView : ""
			, EventName: null
			, TossOption: jsonOpt
		...
		, sMatchString: string)
	{
		...
		this._MyOw.Dom_AxeViewList.push({
			AxeViewMoveType: AxeViewMoveType.Dom
			, Dom: domPushData
			, DataView: ""
			, EventName: null
			, TossOption: jsonOpt
		...
		, sMatchString: string)
	{
		...
		this._MyOw.Dom_AxeViewList.push({
			AxeViewMoveType: AxeViewMoveType.Attr_Valueless
			, Dom: domPushData
			, DataView: ""
			, EventName: null
			, TossOption: jsonOpt
		...
		, sMatchString: string)
	{
		...
		this._MyOw.Dom_AxeViewList.push({
			AxeViewMoveType: AxeViewMoveType.Attr_OneValue
			, Dom: domPushData
			, DataView: ""
			, EventName: null
			, TossOption: jsonOpt
		...
		, sMatchString: string)
	{
		...
		this._MyOw.Dom_AxeViewList.push({
			AxeViewMoveType: AxeViewMoveType.Attr_ReplaceValue
			, Dom: domPushData
			, DataView: ""
			, TossOption: jsonOpt
			, TossOptionType: <T>(): T => { return this.GetOption(jsonOpt); }
		...
		, bPush: boolean)
	{
		...
		let avdTemp: AxeViewDomInterface = {
			AxeViewMoveType: AxeViewMoveType.Attr_Event
			, Dom: domPushData
			, DataView: ""
		...
		if (0 === this._MyOw.Dom_AxeViewList.length)
		{
			...
			switch (objThis.OverwatchingType)
			{
				case OverwatchingType.Monitoring_AttrValue_Input:
					//액스 돔으로 사용할 개체 만들기
					avdTemp = {
						AxeViewMoveType: AxeViewMoveType.Attr_ValueMonitoring
						, Dom: domPushData
						, DataView: ""
						, EventName: "input"
